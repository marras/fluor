/*
 * $Id: xtcio.h,v 1.12 2003/11/17 21:50:43 spoel Exp $
 * 
...
#define CPLUSPLUS ///// g++ nie wiadomo czemu nie ustawia :/
...
int open_xtc(char *filename,char *mode);
/* Open a file for xdr I/O */
  
void close_xtc(int fp);
/* Close the file for xdr I/O */
  
int read_first_xtc(int fp,
